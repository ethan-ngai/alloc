import { QueryMemoryInputSchema, QueryMemoryResultSchema } from "@alloc/contracts";
...
export function registerContextRoutes(app: FastifyInstance, context: ContextRepository): void {
